        ...
        <div id="sidebar-wrapper" class="sidebar-toggle">
            <div id="nav-menu">
                ...
                <div class="submenu" style="background: #373737;">
                    <div class="submenu-heading" id="manhours"><a href="adminManHoursManagement.php" style="text-decoration: none !important;color:#ffffff !important;"> <h5 class="submenu-title" ><img src="images/Man-Hours-W.png" alt="assets" >Man Hours Management</h5></a> </div>                   
                </div>
            </div>
        </div>
    </div>
  ...
  <div class="tab-content" id="myContent">
    ...
    <div class="row col-sm-12">
            <div class="form-group col-sm-4"> 
              <label class="control-label col-sm-4 " for="half_full">Employee:</label>
              <div class="col-sm-8">
    ...
    <div id="outer">
      <?php
        ...
        if(isset($_POST['id'])){ 
          $user_id=$_POST['id'];
          echo "<script>document.getElementById('employee').value = ".$user_id.";</script>";
...
$(document).ready(function(){
  ...
  $('#employee').change(function(){
            window.location.href="adminManHoursManagement.php?id="+$('#employee').val();
          });
  ...
  $('#add').click(function() {
    var element = "<div class='row col-sm-12'>"+
                    "<div class='form-group col-sm-3'>"+ 
                      ...
                      "<div class='col-sm-8'>"+
                        "<select class='form-control select' id='projectid' name='projectid'>"+
                          "<option value='0' >--select--</option>"+
                        "</select>"+
                      "</div>"+
                    "</div>"+    
                    ...
                    "<div class='form-group col-sm-6'>"+ 
                      ...
                      "<div class='col-sm-8'>"+
                        "<textarea class='form-control' id='description' name='description' rows='4' placeholder='Describe in brief'></textarea>"+
                      "</div>"+
                    "</div>"+
                  "</div>";       
