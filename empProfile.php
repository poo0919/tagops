      ...
      <div id="nav-menu">
        ...
        <div class="submenu" >
          <div class="submenu-heading" id="assets">
            <a href="empAssets.php" style="text-decoration: none !important;color:#000000;"> 
              <h5 class="submenu-title" ><img src="images/Assets.png" alt="assets" >Assets</h5>
            </a> 
          </div>                   
        </div>
      ...
      function () {
        ...
        }).change(function()
        {
           // var ID=$(this).attr('id');
            ...
            var dataString = 'ACTION=changeEmpPersonalEmailNumber&userId='+ userId +'&personalEmail='+personal_email;
